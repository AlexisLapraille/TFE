...
from socket import Socket, OutMessage
...
class GUI(tk.Tk):
    ...
    def __init__(self, tunnel: Socket, *, title: str = 'Interface visuelle de test pour la communication bidirectionnelle', min_size: 'tuple[int, int]' = (300, 100)) -> None:
    ...
    def __create_received_msg_label(self):
        self._received_msg_label = tk.StringVar(value='no call yet')
